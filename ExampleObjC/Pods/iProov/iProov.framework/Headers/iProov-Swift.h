...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nullable uuid;)
...
+ (void)enrolWithServiceProviderWithServiceProvider:(NSString * _Nonnull)serviceProvider username:(NSString * _Nonnull)username animated:(BOOL)animated success:(void (^ _Nonnull)(NSString * _Nonnull))success failure:(void (^ _Nonnull)(NSString * _Nonnull))failure error:(void (^ _Nonnull)(NSError * _Nonnull))error;
+ (void)enrolWithTokenWithEncryptedToken:(NSString * _Nonnull)encryptedToken username:(NSString * _Nonnull)username animated:(BOOL)animated success:(void (^ _Nonnull)(NSString * _Nonnull))success failure:(void (^ _Nonnull)(NSString * _Nonnull))failure error:(void (^ _Nonnull)(NSError * _Nonnull))error;
@end
...
@interface UIApplication (SWIFT_EXTENSION(iProov))
@end


@interface UIButton (SWIFT_EXTENSION(iProov))
@end


@interface UIDevice (SWIFT_EXTENSION(iProov))
@end


@interface UIScreen (SWIFT_EXTENSION(iProov))
@end
